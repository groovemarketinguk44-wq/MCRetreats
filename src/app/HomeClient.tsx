  ...
  return (
    <div className="max-w-4xl">
      ...
      <motion.h1
        ...
        className="font-serif font-bold text-[#F2EDE4] mb-6 leading-none"
        style={{
      ...
      >
        {(home.headline as string).split('.').map((part, i, arr) => (
          <span key={i}>
            {part.trim()}
            {i < arr.length - 1 && (
              <>
      ...
      <motion.p
        ...
        className="text-[#C0B0A0] text-xl md:text-2xl leading-relaxed mb-10 max-w-2xl"
      ...
      >
        Secure your place with a £500 deposit · Only 10 rooms
      </motion.p>
    </div>
  )
}
